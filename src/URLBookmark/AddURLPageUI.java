...
public class AddURLPageUI {
    private JPanel panel;
    private JTextField jtfTitle, jtfDescription, jtfURL;
    private JComboBox jcbCategory;
    private JButton jbtExit, jbtAdd;
    
    //constructor
    public AddURLPageUI(){ 
        JLabel jlbPageTitle = new JLabel("Add New URL");
        ...
        jbtAdd.setBackground(new Color(50, 255, 50));
        jbtAdd.setBounds(410,440,120,30);
    ...
    public URLBookmark getUserInput(){
        URLBookmark url = new URLBookmark(this.jtfTitle.getText().trim(),
